...
import com.platformcommons.matching.repository.WorkerLocationRepository;
import com.platformcommons.matching.repository.entity.WorkerLocationEntity;
import com.platformcommons.matching.service.MatchingEngineService;
import com.platformcommons.matching.strategy.FairRoundRobinStrategy;
import com.platformcommons.matching.strategy.MatchingStrategy;
import com.platformcommons.matching.strategy.NearestFirstStrategy;
...
public class MatchingEngineServiceImpl implements MatchingEngineService {
    ...
    private static final Logger log = LoggerFactory.getLogger(MatchingEngineServiceImpl.class);
    ...
    public MatchResult match(String taskId, String strategyName) {
        ...
        if (strategy == null) {
            throw new BizException("unknown strategy: " + strategyName);
        }
